...
At some point while working with my code, the NA under "shape" showed up. It wasn't there at first but then appeared, so I must have messed with something at some point that resulted in NAs coming back. 
...
If you disregard the NA bar, you can clearly see that cone has a much longer duration than all of the other shapes. 
